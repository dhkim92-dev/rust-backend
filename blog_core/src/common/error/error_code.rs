...
impl ErrorCode {
    pub fn cast(self) -> (StatusCode, &'static str, &'static str) {
        match self {
            ...
            Self::Unauthorized => (StatusCode::UNAUTHORIZED, "GE-002", "인증되지 않은 사용자입니다."),
            Self::Forbidden => (StatusCode::FORBIDDEN, "GE-003", "접근이 금지된 리소스입니다."),
            Self::NotFound => (StatusCode::NOT_FOUND, "GE-004", "요청한 리소스를 찾을 수 없습니다."),
            Self::Conflict => (StatusCode::CONFLICT, "GE-005", "이미 존재하는 리소스입니다."),
             ...
             * 인증 관련 에러
             */
            Self::EmailPasswordMismatch => (StatusCode::UNAUTHORIZED, "AE-001", "이메일 또는 비밀번호가 일치하지 않습니다."),
            Self::JwtBuildClaimsException => (StatusCode::INTERNAL_SERVER_ERROR, "AE-002", "JWT Claims 생성 중 오류가 발생했습니다."),
            Self::InvalidJwtToken => (StatusCode::UNAUTHORIZED, "AE-003", "유효하지 않은 JWT 토큰입니다."),
             ...
             * 멤버 관련 에러
             */
            Self::MemberNotFound => (StatusCode::BAD_REQUEST, "ME-001", "존재하지 않는 회원입니다."),
            Self::EmailAlreadyExists => (StatusCode::BAD_REQUEST, "ME-002", "이미 존재하는 이메일입니다."),
        }
    }
